...
public class AmpJointIOTalonFX implements AmpJointIO {
  private static final double GEAR_RATIO = 20;

  private final TalonFX leader = new TalonFX(57); // TODO: SET
  ...
  @Override
  public void updateInputs(AmpJointIOInputs inputs) {
